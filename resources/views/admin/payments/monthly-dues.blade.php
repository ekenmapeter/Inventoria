<x-admin-layout>
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Monthly Dues Payments</h1>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Review and manage monthly dues payments</p>
            </div>
            <div class="flex gap-2">
                <x-button href="{{ route('admin.payments.monthly-dues.create') }}" variant="primary">
        ...
        @else
            <x-card class="text-center py-12">
                <p class="text-gray-500 dark:text-gray-400">No monthly dues payments found.</p>
            </x-card>
        @endif
    </div>
</x-admin-layout>
