<x-admin-layout>
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">All Payments</h1>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Review and manage all payment requests</p>
            </div>
                        ...
                        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($payments as $payment)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="badge {{ $payment->isMonthlyDue() ? 'badge-primary' : 'badge-accent' }}">
