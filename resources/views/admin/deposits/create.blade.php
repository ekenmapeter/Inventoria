    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add Deposit</h1>
            </div>
        </div>
        ...
        <x-card>
            <form method="POST" action="{{ route('admin.deposits.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">If approved, the member's subscription will be activated automatically and a payment record will be created.</p>
                ...
                <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <x-button href="{{ route('admin.deposits.index') }}" variant="outline">
                        Cancel
                    </x-button>
