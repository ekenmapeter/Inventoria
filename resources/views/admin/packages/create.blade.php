            ...
            <form method="POST" action="{{ route('admin.packages.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div id="min_amount_container" style="display: none;">
                        ...
                        <x-text-input id="min_amount" name="min_amount" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('min_amount')" />
                    ...
                    <div id="max_amount_container" style="display: none;">
                        ...
                        <x-text-input id="max_amount" name="max_amount" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('max_amount')" />
