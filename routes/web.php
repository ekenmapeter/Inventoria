...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/products', function() {
        return App\Models\Product::select('id', 'item_code', 'description', 'sales_price', 'quantity')
            ->orderBy('item_code')
            ->get();
    });
    ...
    Route::get('/api/brands', [BrandController::class, 'apiIndex']);
    Route::post('/api/brands', [BrandController::class, 'apiStore']);
    Route::put('/api/brands/{brand}', [BrandController::class, 'apiUpdate']);
    Route::delete('/api/brands/{brand}', [BrandController::class, 'apiDestroy']);

    Route::resource('units', UnitController::class)->only(['index', 'create', 'store', 'edit', 'update', 'destroy']);
    // API routes for units
    Route::get('/api/units', [UnitController::class, 'apiIndex']);
    Route::post('/api/units', [UnitController::class, 'apiStore']);
    Route::put('/api/units/{unit}', [UnitController::class, 'apiUpdate']);
    Route::delete('/api/units/{unit}', [UnitController::class, 'apiDestroy']);
    ...
    Route::get('/api/adjustments', [AdjustmentController::class, 'apiIndex']);
    Route::post('/api/adjustments', [AdjustmentController::class, 'apiStore']);

    Route::resource('stock-counts', StockCountController::class)->only(['index', 'create', 'store', 'show']);
    Route::post('/api/stock-counts', [StockCountController::class, 'apiStore']);
